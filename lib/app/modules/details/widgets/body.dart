...
import '../../../widgets/facilitywidget.dart';
...
class Body extends StatefulWidget {
  ...
  Body({Key? key, required this.data, required this.nearByPlaces}) : super(key: key);
...
class _BodyState extends State<Body> with TickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    setState(() {
      myfavorite = authController.firestoreUser.value!.favorite!
          .contains(widget.data.id);
    });
    var imagelist = widget.data.urlimginside;
    // ! + widget.data.urlimgoutside;
        ...
        children: [
                        ...
                        builder: (controller) => IconButton(
                              ...
                              icon: Icon(
                                ...
                                color: authController
                                        .firestoreUser.value!.favorite!.contains(widget.data.id)
                                    ? Colors.red
                                    : Colors.white,
                              ),
                            )),
          ...
          Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                Text(
                  widget.data.name!.replaceAll(new RegExp(r'-'), ' '),
                  ...
                  children: [
                    Container(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(labels!.propertydetail!.pricelabel,
                              style: themeData.textTheme.bodyText1),
                          Text(
          ...
          Container(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: <Widget>[
                Text(labels.propertydetail!.detaillabel,
                    style: themeData.textTheme.bodyText1),
                Container(
                    margin: EdgeInsets.only(top: 8),
