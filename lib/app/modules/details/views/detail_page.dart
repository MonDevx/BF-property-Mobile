...
class _DetailPageState extends State<DetailPage> {
  ...
  void initState() {
    ...
    _loadRealestate = loadRealestate(Get.arguments) as Future<RealEstateModel>?;
                ...
                FlatButton.icon(
                  ...
                  onPressed: _isButtonDisabled!
                      ...
                      : () async {
                          ...
                          if (_controllername.text.isPhoneNumber) {
                            setState(() {
                              isvaildphone = true;
                            });
                          } else {
          ...
          child: Row(
            ...
            children: [
              ...
              FloatingWidget(
                ...
                txt: labels?.propertydetail?.callabel, onPressed: (){},
              ),
            ],
          ),
        ),
