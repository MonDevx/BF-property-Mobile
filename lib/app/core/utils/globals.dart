import 'dart:io';
import 'package:bfproperty/app/data/models/menu_option_model.dart';
...
//https://docs.google.com/spreadsheets/d/1oS7iJ6ocrZBA53SxRfKF0CG9HAaXeKtzvsTBhgG4Zzk/edit?usp=sharing
  ...
  static List<MenuOptionsModel> languageOptions() {
  ...
  static List<MenuOptionsModel> themeOptions() {
    return [
      MenuOptionsModel(key: "light", value: "Light theme"),
      MenuOptionsModel(key: "dark", value: "Dark theme"),
      MenuOptionsModel(key: "system", value: "Defaut system"),
    ];
  }
}
